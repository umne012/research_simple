def show_relation_tab():
    ...
    with open("network_graph.html", "w", encoding="utf-8") as f:
        ...
        <head>
            ...
            <style>
                ...
                .text-link {{ display: block; margin-bottom: 10px; font-size: 12px; color: black; text-decoration: none; }}
        ...
        <div id='sentence-panel'>
            <h3>📝 관련 문장 (<span id='mention-count'>0</span>회)</h3>
        ...
        <script>
            ...
            node.on("click", (event, d) => {
                ...
                const countSpan = document.getElementById("mention-count");
                ...
                panel.innerHTML = data.map(s => `
                    <a class='text-link' href='${s["원본링크"]}' target='_blank'>${s["문장"]}</a>
                `).join("");
            });
    ...
    st.components.v1.html(open("network_graph.html", encoding="utf-8").read(), height=650)
